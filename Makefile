all:
	...
	gcc -Wall -o coloracao.o -c coloracao.c
	gcc -Wall -o main.out grafo.o listaVertice.o listaEstrela.o listaAresta.o pilha.o fila.o lista.o buscaLargura.o buscaProfundidade.o coloracao.o main.c
